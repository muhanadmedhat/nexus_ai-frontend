...
const STYLES: Record<string, string> = {
  ...
  waiting_for_pr: "bg-tertiary-container/15 text-tertiary-container",
  planning_matching: "bg-surface-container-high text-on-surface-variant",
  ready_for_funding: "bg-success/15 text-success",
  ...
  ready_for_implementation_funding: "bg-success/15 text-success",
